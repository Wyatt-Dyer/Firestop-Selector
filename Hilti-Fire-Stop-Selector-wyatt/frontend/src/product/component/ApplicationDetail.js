                    ...
                    <div className="card-body">
                        <form onSubmit={submit}>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-12 col-md-8">
                                    <input type="text" id="application_name" className="form-control" placeholder="Applicationname" onChange={handleChange} value={state.input.application_name} required/>
                                </div>
                            </div>
                            <div className="form-group row">
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-12 col-md-8">
                                    <select type="text" id="application_type" className="form-control" placeholder="" onChange={handleChange} value={state.input.application_type} disabled>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-12 col-md-8">
                                <select type="text" id="application_wallfloor" className="form-control" placeholder="" onChange={handleChange} value={state.input.application_wallfloor}>
                                        <option value="">- select -</option>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-12 col-md-8">
                                    <input type="text" id="application_construction_type" className="form-control" placeholder="application_construction_type" onChange={handleChange} value={state.input.application_construction_type}/>
                                </div>
                            </div>
                            <div className="form-group row">
                                <label className="col-12 col-md-4">Subcategory</label>
                                <div className="col-12 col-md-8">
                                    <input type="text" id="application_subcategory" className="form-control" placeholder="application_subcategory" onChange={handleChange} value={state.input.application_subcategory}/>
                                </div>
                            </div>
                            <div className="form-group row">
                                <label className="col-12 col-md-4">Thickness</label>
                                <div className="col-12 col-md-8">
                                    <input type="text" id="application_thickness" className="form-control" placeholder="application_thickness" onChange={handleChange} value={state.input.application_thickness}/>
                                </div>
                            </div>
                            <div>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-12 col-md-8">
                                    <input type="text" id="application_max_pipe_size" className="form-control" placeholder="Application Maximum pipe size" onChange={handleChange} value={state.input.application_max_pipe_size}/>
                                </div>
                            </div>
                            <div className="form-group row">
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-12 col-md-8">
                                    <input type="text" id="application_hyper" className="form-control" placeholder="application_hyper" onChange={handleChange} value={state.input.application_hyper} />
                                </div>
                            </div>
                            <div className="form-group row">
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-12 col-md-8">
                                    <input type="text" id="approval_number" className="form-control" placeholder="approval_number" onChange={handleChange} value={state.input.approval_number}/>
                                </div>
                            </div>
                            <div className="form-group row">
                                <label className="col-12 col-md-4">Approval Page</label>
                                <div className="col-12 col-md-8">
                                    <input type="text" id="approval_page" className="form-control" placeholder="approval_page" onChange={handleChange} value={state.input.approval_page}/>
                                </div>
                            </div>
                            <div className="form-group row">
                                <label className="col-12 col-md-4">Approval Table</label>
                                <div className="col-12 col-md-8">
                                    <input type="text" id="approval_table" className="form-control" placeholder="approval_table" onChange={handleChange} value={state.input.approval_table}/>
                                </div>
                            </div>
                            <div className="form-group row">
                                <label className="col-12 col-md-4">Approval Figure Number</label>
                                <div className="col-12 col-md-8">
                                    <input type="text" id="approval_figure" className="form-control" placeholder="approval_figure" onChange={handleChange} value={state.input.approval_figure} />
                                </div>
                            </div>
                            <div className="form-group row">
                                <label className="col-12 col-md-4">Approval Hyperlink</label>
                                <div className="col-12 col-md-8">
                                    <input type="text" id="approval_hyper" className="form-control" placeholder="approval_hyper" onChange={handleChange} value={state.input.approval_hyper} />
                                </div>
                            </div>
